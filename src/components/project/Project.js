...
function Project() {
  ...
  let data = [
    ...
    },
    {
      ...
      githubFrontEnd:
        "https://github.com/Shersha123/capstone-frontend.git",
    ...
    // },
     {
      key: ["react", "express", "all", "restApi", "mern", "node"],
      img: "./asset/project/equipment.png",
      title: "EQUIPMENT RENTAL PORTAL",
      githubFrontEnd: "https://github.com/Shersha123/equipfrontend.git",
      githubBackEnd: "https://github.com/Shersha123/equipmentbackend.git",
      sourceCode: "https://equipfrontend.vercel.app/equipment",
      shortNote:
    ...
    {
      key: ["react", "express", "all", "restApi", "mern", "node"],
      img: "./asset/project/pizza hut.png",
      title: "PIZZA HUT",
      githubFrontEnd: "https://github.com/Shersha123/pizzafrontend.git",
      githubBackEnd: "https://github.com/Shersha123/pizzabackend.git",
      sourceCode: "https://kaleidoscopic-naiad-963d1a.netlify.app",
      shortNote:
        "Pizza delivery apps service allows customers to pick from different flavours of pizza & they can customize their pizza by adding toppings, spices, ingredients etc.",
      longNote: [
        // "This is  **fullstack** web application",
        "The frontend is built using **React** with **Bootstrap** for styling.",
        "The backend is build with **Node.js** , **Express.js** and uses **MongoDB** as database.",
    ...
    },
    {
      ...
      title: "Post Man",
      githubFrontEnd: "https://github.com/Shersha123/post_office.git",
      githubBackEnd: "",
      sourceCode: "https://remarkable-smakager-fa0d14.netlify.app/",
      shortNote:
    ...
    },
    {
      ...
      title: "Thirukural",
      githubFrontEnd: "https://github.com/Shersha123/Thirukural.git",
      githubBackEnd: "",
      sourceCode: "https://splendid-buttercream-4e9be6.netlify.app",
      shortNote:
