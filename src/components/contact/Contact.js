              ...
              <div>
                <div className="contact-icon">
                  ...
                  <p
                    onClick={() =>
                      window.open(
                        "https://linkedin.com/in/shersha-ahamed-n-137846235",
                        "_blank"
                      )
                    }
                  >
                  ...
                  >
                    <CallIcon fontSize="medium" /> +91 9566364289
                  </p>
                  <p className="ss"
                    onClick={() =>
                      window.open("mailto:ukkasnaina99@gmail.com", "_blank")
                    }
                  >
                    <MailIcon fontSize="medium" /> ukkasnaina99@gmail.com
                  </p>
                </div>
                <div>
                  <img
