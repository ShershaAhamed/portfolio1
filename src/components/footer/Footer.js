...
function Footer() {
  return (
    <footer class="footer">
      <div>
        <span className='footer-icon' onClick={() => window.open("https://github.com/Shersha123", "_blank")}> <GitHubIcon fontSize='small' /> </span>
      ...
      <div >
        <p class="m-2">Copyright &copy; 2022 All rights reserved | Shersha Ahamed</p>
      </div>
    </footer>
  )
}
